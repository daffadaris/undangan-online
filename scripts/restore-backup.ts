    ...
    if (existingConfig) {
      await prisma.weddingConfig.update({
        ...
        data: {
          ...
          showLoveStory: cfg.showLoveStory === 1 || cfg.showLoveStory === true,
          showGiftInfo: cfg.showGiftInfo === 1 || cfg.showGiftInfo === true,
          showRsvp: cfg.showRsvp === 1 || cfg.showRsvp === true,
          showGallery: cfg.showGallery === 1 || cfg.showGallery === true,
          showAkad: cfg.showAkad === 1 || cfg.showAkad === true,
          showResepsi: cfg.showResepsi === 1 || cfg.showResepsi === true,
