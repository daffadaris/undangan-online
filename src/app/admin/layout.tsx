      ...
      <aside className={`admin-sidebar ${isSidebarOpen ? "sidebar-open" : ""}`}>
        ...
        <nav className="sidebar-menu">
          ...
          {currentUser?.role !== "super_admin" && (
            <Link href="/admin/checkin" onClick={closeSidebar} className={`sidebar-link ${pathname === "/admin/checkin" ? "active" : ""}`}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7" /><rect x="14" y="3" width="7" height="7" /><rect x="3" y="14" width="7" height="7" /><path d="M14 14h3v3h-3zM20 14v.01M14 20h.01M17 20h4v-3" /></svg>
              Check-in Tamu
            </Link>
          )}
          {currentUser?.role !== "super_admin" && (
